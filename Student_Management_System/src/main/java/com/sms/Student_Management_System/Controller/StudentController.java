...
//    Notifications
    ...
    public List<Notifications> getAllNotificationsPagewise(@RequestParam(defaultValue = "0") int pageNumber,@RequestParam(defaultValue = "10") int numberOfData){

        List<Notifications> notifications = studentService.getAllNotificationsPagewise(pageNumber,numberOfData);
